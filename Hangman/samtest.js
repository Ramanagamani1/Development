...
(() => {
  var e = {
      893: (e) => {
        const t = "https://hangman-rns.herokuapp.com/api/sessions";
        e.exports = {
          createSession: async function (e, n) {
            return (
              await fetch(`${t}/`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ name: e, categoryId: n }),
              })
            ).json();
          },
          playInSession: async function (e, n) {
            return (
              await fetch(`${t}/${e}/play`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ letter: n }),
              })
            ).json();
          },
      ...
      892: (e, t, n) => {
        ...
        o.push([
          ...
          o.push([
            e.id,
            'html,body,div,span,applet,object,iframe,h1,h2,h3,h4,h5,h6,p,blockquote,pre,a,abbr,acronym,address,big,cite,code,del,dfn,em,img,ins,kbd,q,s,samp,small,strike,strong,sub,sup,tt,var,b,u,i,center,dl,dt,dd,ol,ul,li,fieldset,form,label,legend,table,caption,tbody,tfoot,thead,tr,th,td,article,aside,canvas,details,embed,figure,figcaption,footer,header,hgroup,menu,nav,output,ruby,section,summary,time,mark,audio,video{margin:0;padding:0;border:0;font-size:100%;font:inherit;vertical-align:baseline}article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{display:block}body{line-height:1}ol,ul{list-style:none}blockquote,q{quotes:none}blockquote:before,blockquote:after,q:before,q:after{content:"";content:none}table{border-collapse:collapse;border-spacing:0}.game-wrapper{height:100%;width:100vw;background:#323232;display:flex;flex-direction:column;justify-content:space-between;align-items:center}.left-pane{width:100%;height:70vh;background:#fff2f9;display:flex;justify-content:center}.right-pane{flex:1;color:white}.start-container{position:relative;top:50%;transform:translateY(-50%);height:300px;width:100vw;display:flex;flex-direction:column;justify-content:space-around;align-items:center}.start-inputs{width:40%;display:flex;flex-direction:column;justify-content:center;transition:all 1000ms ease-in-out}.start-inputs__input{padding:5px;margin-right:10px;border-radius:10px}.start-inputs__select{border-radius:10px;padding:10px;background-color:#fff2f9;margin-top:10px}.start-button{font-family:"Mochiy Pop P One", sans-serif;background:#fff2f9;padding:1rem 2.5rem;display:inline-grid;place-items:center;font-size:1rem;color:#323232;border-radius:15px;border:2px solid #fa4eab;position:relative;transform-style:preserve-3D;transition:transform 150ms ease-in-out, background 150ms ease-in-out;cursor:pointer}.start-button::before{content:"";width:100%;height:100%;position:absolute;background:repeating-linear-gradient(to right, transparent, transparent 5px, #fa4eab 5px, #fa4eab 10px),#fe83c6;border:2px solid #fa4eab;border-radius:15px;box-shadow:0px 15px 4px -2px rgba(254,131,198,0.25);transform:translate3D(0, 1.5rem, -2rem);transition:transform 150ms ease-in-out, box-shadow 150ms ease-in-out}.start-button[disabled]{pointer-events:none;transition:none;text-decoration:line-through 5px greenyellow}.start-button[disabled]:hover{cursor:default}.start-button:active,.start-button:hover{transform:translate(0, 0.5rem);background:#ffe5f3}.start-button:active::before,.start-button:hover::before{transform:translate3D(0, 1rem, -2rem);box-shadow:0px 10px 4px -2px rgba(254,131,198,0.25)}.start-button--letter{padding:1rem 1.5rem;margin-bottom:2rem;margin-left:0.5rem;margin-right:0.5rem}.hangman-container{position:relative;top:7%;right:10%;display:flex;justify-content:space-between;align-items:baseline;padding-left:10rem;padding-top:8rem;box-sizing:border-box}.pole{position:absolute;height:400px;top:2rem;left:3rem;border-left:10px solid brown;border-top:10px solid brown;width:10rem}.pole::after{content:"";height:2.5rem;width:10px;background:brown;position:absolute;right:0}.hangman{position:relative}.hangman__element{opacity:0.25}.hangman__element:nth-child(1){height:100px;width:100px;border-radius:50%;border:10px solid black}.hangman__element:nth-child(1)::after{position:absolute;content:"● ●";font-size:3rem;color:black;margin-left:10px;display:none}.hangman__element:nth-child(1)::before{content:"(";font-size:3rem;font-family:sans-serif;position:absolute;top:50px;left:50px;margin-left:5px;display:none}.hangman__element:not(:first-child){height:100px;width:10px;background-color:black}.hangman__element:nth-child(2){position:absolute;height:120%;left:55px}.hangman__element:nth-child(3){position:absolute;transform:rotate(45deg);left:20px;top:120%}.hangman__element:nth-child(4){position:absolute;transform:rotate(-45deg);left:90px;top:120%}.hangman__element:nth-child(5){position:absolute;transform:rotate(45deg);left:20px;top:202%}.hangman__element:nth-child(6){position:absolute;transform:rotate(-45deg);left:90px;top:202%}.hangman-1 .hangman__element:nth-child(1){opacity:1}.hangman-2 .hangman__element:nth-child(1){opacity:1}.hangman-2 .hangman__element:nth-child(2){opacity:1}.hangman-3 .hangman__element:nth-child(1){opacity:1}.hangman-3 .hangman__element:nth-child(2){opacity:1}.hangman-3 .hangman__element:nth-child(3){opacity:1}.hangman-4 .hangman__element:nth-child(1){opacity:1}.hangman-4 .hangman__element:nth-child(2){opacity:1}.hangman-4 .hangman__element:nth-child(3){opacity:1}.hangman-4 .hangman__element:nth-child(4){opacity:1}.hangman-5 .hangman__element:nth-child(1){opacity:1}.hangman-5 .hangman__element:nth-child(2){opacity:1}.hangman-5 .hangman__element:nth-child(3){opacity:1}.hangman-5 .hangman__element:nth-child(4){opacity:1}.hangman-5 .hangman__element:nth-child(5){opacity:1}.hangman-6 .hangman__element:nth-child(1){opacity:1}.hangman-6 .hangman__element:nth-child(2){opacity:1}.hangman-6 .hangman__element:nth-child(3){opacity:1}.hangman-6 .hangman__element:nth-child(4){opacity:1}.hangman-6 .hangman__element:nth-child(5){opacity:1}.hangman-6 .hangman__element:nth-child(6){opacity:1}.hangman-7 .hangman__element:nth-child(1){opacity:1}.hangman-7 .hangman__element:nth-child(2){opacity:1}.hangman-7 .hangman__element:nth-child(3){opacity:1}.hangman-7 .hangman__element:nth-child(4){opacity:1}.hangman-7 .hangman__element:nth-child(5){opacity:1}.hangman-7 .hangman__element:nth-child(6){opacity:1}.hangman-7 .hangman__element:nth-child(7){opacity:1}.hangman-6{top:-50px}.hangman-6 .hangman__element:nth-child(1)::after{display:block}.hangman-6 .hangman__element:nth-child(1)::before{display:block;transform:rotate(90deg)}.hangman-7 .hangman__element:nth-child(1)::after{display:block}.hangman-7 .hangman__element:nth-child(1)::before{display:block;transform:rotate(270deg);left:40px}.word{font-size:2rem;font-family:"Mochiy Pop P One", sans-serif}.lives{position:relative;color:#323232;font-size:1.5rem;font-family:"Mochiy Pop P One", sans-serif}.result-wrapper{height:100vh;width:100vw;display:flex;justify-content:space-between;flex-direction:column;align-items:center}.result-pane{position:relative;bottom:10%;display:flex;flex-direction:column;justify-content:space-between}.result-pane__header{font-size:2rem}.gradient-text{background-color:#6c36d8;background-image:linear-gradient(45deg, #fa4eab 50%, #323232 50%);background-size:270%;background-repeat:repeat;background-position:top right;background-clip:text;-webkit-background-clip:text;-webkit-text-fill-color:transparent;-moz-background-clip:text;-moz-text-fill-color:transparent;animation:button-animation 0.65s 0.15s ease-out forwards}.res-btn{margin-left:auto;margin-right:auto;margin-top:10px;background-image:linear-gradient(45deg, #323232 50%, #fa4eab 50%);background-size:270%;background-repeat:repeat;background-position:top right;box-shadow:13px 10px 10px 0px rgba(0,0,0,0.75);border-radius:0.5em;padding:1.5em 0;animation:button-animation 0.65s 0.15s ease-out forwards;cursor:pointer;transition:0.5s}.res-btn span{font-weight:normal;font-size:2em;text-align:center;margin-bottom:0;margin-bottom:-0.25em;width:100%;padding:0 1.5em}.res-btn:hover,.res-btn:hover span{animation:button-animation-rev 0.65s ease-out forwards}.res-btn:hover{box-shadow:7px 7px 5px 0px rgba(0,0,0,0.75);transform:translate(0.5rem, 0.5rem);transition:0.5s}@keyframes button-animation{0%{background-position:top right}100%{background-position:top left}}@keyframes button-animation-rev{0%{background-position:top left}100%{background-position:top right}}*{font-family:"Mochiy Pop P One", sans-serif;text-decoration:none}.hangman-header{font-size:50px;height:70px;font-family:"Mochiy Pop P One", sans-serif;position:absolute;left:50%;margin-top:10px;transform:translateX(-50%);background:linear-gradient(45deg, #ca4246 16.666%, #e16541 16.666%, #e16541 33.333%, #f18f43 33.333%, #f18f43 50%, #8b9862 50%, #8b9862 66.666%, #476098 66.666%, #476098 83.333%, #a7489b 83.333%);background-clip:text;-webkit-background-clip:text;-webkit-text-fill-color:transparent;cursor:default}.hangman-header:hover{animation:rainbow-text-simple-animation-rev 0.75s ease forwards}@keyframes rainbow-text-simple-animation-rev{0%{background-size:650%}40%{background-size:350%}100%{background-size:100%}}.display-none{display:none}.display-flex{display:flex;flex-wrap:wrap}.justify-content-center{justify-content:center}.justify-content-around{justify-content:space-around}.word-flex{margin-bottom:5rem}.success{color:#87f5fb}.danger{color:#fc2f00}@media (min-width: 500px){.game-wrapper{height:100vh;width:100vw;flex-direction:row;justify-content:center}.start-container{top:0;transform:none}.start-inputs{width:100%;flex-direction:row}.start-inputs__select{margin-top:0}.left-pane{margin-right:auto;width:30%;height:100vh;align-items:flex-end}.hangman-container{height:750px;top:0;right:0}.start-button{font-size:2rem}.lives{font-size:3rem;position:absolute;bottom:10%;right:0;left:auto}.pole{height:700px}.pole::after{height:5.5rem}.word{font-size:5rem}.hangman__element:nth-child(2){height:300px}.hangman__element:nth-child(3){top:150px}.hangman__element:nth-child(4){top:150px}.hangman__element:nth-child(5){top:400px}.hangman__element:nth-child(6){top:400px}.hangman-6{top:0px}.hangman-7{top:125px}.result-wrapper{flex-direction:row;justify-content:center;height:100vh}.result-pane{margin-right:auto;height:300px;bottom:0}.result-pane__header{font-size:3rem}}\n',
            "",
          ]);
        const i = o;
      },
      ...
      448: (e, t, n) => {
        ...
        function jr(e, t, n, r, a) {
          for (var l = t._reactName, o = []; null !== n && n !== r; ) {
            ...
            5 === i.tag &&
              ...
              ((i = s),
              a
                ? null != (u = Ue(n, l)) && o.unshift(Ir(n, u, i))
                : a || (null != (u = Ue(n, l)) && o.push(Ir(n, u, i)))),
              (n = n.return);
          }
        ...
        function Ka() {
          if (!Aa && null !== ja) {
            ...
            try {
              ...
              throw (null !== ja && (ja = ja.slice(e + 1)), _a(Ta, qa), t);
            } finally {
              Aa = !1;
            }
          }
        ...
        function Sl(e) {
          ...
          function p(e, t, n, r) {
            ...
            if ("object" == typeof n && null !== n) {
              ...
              if (kl(n) || W(n)) return null !== a ? null : f(e, t, n, r, null);
              xl(e, n);
            }
            return null;
          }
              ...
              switch (l.$$typeof) {
                case E:
                  e: {
                    ...
                    l.type === S
                      ? (((r = Hu(l.props.children, e.mode, u, l.key)).return =
                          e),
                        (e = r))
                      : (((u = Vu(
                          l.type,
        ...
        function Ol(e, t) {
          switch ((ca(Ll, t), ca(zl, e), ca(Nl, Pl), (e = t.nodeType))) {
            case 9:
            case 11:
            ...
            if (t) {
              ...
              if (!Wl(e, t)) {
                if (!(t = qr(n.nextSibling)) || !Wl(e, t))
                  return (
                    (e.flags = (-1025 & e.flags) | 2), (Al = !1), void (jl = e)
                  );
                $l(jl, n);
              }
              (jl = e), (Ul = qr(t.firstChild));
            } else (e.flags = (-1025 & e.flags) | 2), (Al = !1), (jl = e);
          }
        }
        function Vl(e) {
          for (
        ...
        function Hl(e) {
          ...
          if (
            ...
            for (t = Ul; t; ) $l(e, t), (t = qr(t.nextSibling));
          if ((Vl(e), 13 === e.tag)) {
        ...
        function lo(e, t, n, r, a, l) {
          if (
            ...
            (t.updateQueue = null),
            (t.lanes = 0),
            (Yl.current = null === e || null === e.memoizedState ? Oo : Mo),
            (e = n(r, a)),
            no)
          ) {
            l = 0;
        ...
        function ti(e, t, n) {
          ...
          if ((ca(Fl, r), 0 == (2 & t.mode))) t.memoizedState = null;
          else
            switch (a) {
              case "forwards":
                  ...
                  : ((r = null !== r),
                    ...
                    r &&
                      ...
                      0 != (1 & Fl.current)
                        ...
                        : ((0 !== Ii && 3 !== Ii) || (Ii = 4),
                          null === Li ||
                            (0 == (134217727 & ji) && 0 == (134217727 & Ui)) ||
                            mu(Li, Oi))),
                    (r || n) && (t.flags |= 4),
                    null)
              );
            case 4:
              return Ml(), null === e && Tr(t.stateNode.containerInfo), null;
            case 10:
              return nl(t), null;
            case 19:
              if ((sa(Fl), null === (r = t.memoizedState))) return null;
                      ...
                      if (null !== (s = Dl(e))) {
                        for (
                          ...
                          (e = r),
                            ...
                            (n = n.sibling);
                        return ca(Fl, (1 & Fl.current) | 2), t.child;
                      }
                      e = e.sibling;
                    }
                  null !== r.tail &&
        ...
        function li(e) {
          switch (e.tag) {
            ...
            case 3:
              if ((Ml(), sa(pa), sa(da), Kl(), 0 != (64 & (t = e.flags))))
                throw Error(o(285));
        ...
        function xi(e, t) {
          switch (t.tag) {
            ...
            case 13:
              return (
                null !== t.memoizedState && ((Wi = Wa()), mi(t.child, !0)),
                void Si(t)
              );
            case 19:
              return void Si(t);
        ...
        var Hi,
          ...
          uu = !1;
        function su() {
          return 0 != (48 & zi) ? Wa() : -1 !== au ? au : (au = Wa());
        }
        function cu(e) {
          if (0 == (2 & (e = e.mode))) return 1;
          if (0 == (4 & e)) return 99 === Ba() ? 1 : 2;
          if ((0 === lu && (lu = Di), 0 !== Ya.transition)) {
        ...
        function fu(e, t, n) {
          ...
          Wt(e, t, n), e === Li && ((Ui |= t), 4 === Ii && mu(e, Oi));
          var r = Ba();
          1 === t
            ? 0 != (8 & zi) && 0 == (48 & zi)
              ? gu(e)
        ...
        function pu(e, t) {
          ...
          if (((r = Dt(e, e === Li ? Oi : 0)), (t = It), 0 === r))
            ...
            15 === t
              ? ((n = gu.bind(null, e)),
                null === ja ? ((ja = [n]), (Ua = _a(Ta, Ka))) : ja.push(n),
                (n = Fa))
              : 14 === t
        ...
        function hu(e) {
          if (((au = -1), (ou = lu = 0), 0 != (48 & zi))) throw Error(o(327));
          ...
          if (
            ...
            if (
              ...
              throw ((t = Fi), ku(e, 0), mu(e, n), pu(e, Wa()), t);
            switch (
              ...
              case 3:
                if (
                  (mu(e, n), (62914560 & n) === n && 10 < (r = Wi + 500 - Wa()))
                ) {
                  if (0 !== Dt(e, 0)) break;
                  ...
                  e.timeoutHandle = Vr(zu.bind(null, e), r);
                  break;
                }
                zu(e);
                break;
              case 4:
                ...
                if (
                  ...
                  e.timeoutHandle = Vr(zu.bind(null, e), n);
                  break;
                }
                zu(e);
                break;
        ...
        function gu(e) {
          ...
          if (
            ...
            throw ((n = Fi), ku(e, 0), mu(e, t), pu(e, Wa()), n);
          return (
        ...
        function Su(e, t) {
          ...
          if ((tl(), (zi = n), (Pi.current = r), null !== Ti))
            throw Error(o(261));
        ...
        function Nu(e) {
          ...
          do {
            ...
            if (((e = t.return), 0 == (2048 & t.flags))) {
              if (null !== (n = ai(n, t, Mi))) return void (Ti = n);
              if (
                (24 !== (n = t).tag && 23 !== n.tag) ||
                null === n.memoizedState ||
                0 != (1073741824 & Mi) ||
        ...
        function zu(e) {
          var t = Ba();
          return Ha(99, Lu.bind(null, e, t)), null;
        }
        function Lu(e, t) {
          do {
            Ou();
          ...
          if (
            ...
            (Kt = !!Ar), ($r = Ar = null), (e.current = n), (Qi = r);
            do {
              try {
                for (b = e; null !== Qi; ) {
                  var x = Qi.flags;
          ...
          if ((pu(e, Wa()), qi)) throw ((qi = !1), (e = Ki), (Ki = null), e);
        ...
        function Iu() {
          if (null === Gi) return !1;
          var e = Gi;
          if (((Gi = null), 0 != (48 & zi))) throw Error(o(331));
          var t = zi;
          zi |= 32;
          var n = eu;
          eu = [];
        ...
        function Vu(e, t, n, r, a, l) {
          ...
          if (((r = e), "function" == typeof e)) Wu(e) && (i = 1);
            ...
            e: switch (e) {
              ...
              case j:
                return (
                  ((e = $u(24, n, t, a)).elementType = j), (e.lanes = l), e
                );
              default:
          ...
          switch (((t.lanes = 0), t.tag)) {
            ...
            case 4:
              return (
                Ol(t, t.stateNode.containerInfo),
                (r = t.pendingProps),
                null === e ? (t.child = _l(t, null, r, n)) : Do(e, t, r, n),
                t.child
              );
            case 11:
              return (
        ...
        var ls = { Events: [na, ra, aa, Le, Te, Ou, { current: !1 }] },
          os = {
              ...
              o > i
                ? ((e.sortIndex = o),
                  ...
                  null === x(C) &&
                    e === x(P) &&
                    (M ? a() : (M = !0), r(I, o - i)))
                : ((e.sortIndex = u), E(C, e), O || T || ((O = !0), n(F))),
              e
            );
          }),
  ...
  (n.n = (e) => {
    ...
    (() => {
      ...
      var e = n(294),
        t = n(935);
      function r({ onStart: t, categories: n }) {
        const [r, a] = (0, e.useState)(""),
          [l, o] = (0, e.useState)("City");
        return e.createElement(
          e.Fragment,
          null,
          e.createElement(
            "div",
            { className: "game-wrapper", style: { height: "100vh" } },
            e.createElement(
              "div",
              { className: "start-container" },
              e.createElement(
                "div",
                { className: "start-inputs" },
      ...
      function a({ livesLeft: t }) {
        return e.createElement(
          "div",
          { className: "hangman-container" },
          e.createElement(
            "div",
            { className: "hangman-struct" },
            e.createElement("div", { className: "pole" }),
            e.createElement(
              "div",
              { className: "hangman hangman-" + (6 - t) },
              e.createElement("div", { className: "hangman__element" }),
              e.createElement("div", { className: "hangman__element" }),
              e.createElement("div", { className: "hangman__element" }),
              e.createElement("div", { className: "hangman__element" }),
              e.createElement("div", { className: "hangman__element" }),
          ...
          -1 !== t &&
            e.createElement("div", { className: "lives" }, "Lives: ", t)
        );
      }
      function l() {
        return (
      ...
      function m(t) {
        return (function (t) {
          let n = (0, e.useContext)(h).outlet;
          return n ? (0, e.createElement)(E.Provider, { value: t }, n) : n;
        })(t.context);
      }
      function g(e) {
        f(!1);
      ...
      function v(t) {
        ...
        let {
          ...
          k = (0, e.useMemo)(() => {
            ...
            return null == e
              ? null
              : { pathname: e, search: g, hash: v, state: y, key: w };
          }, [s, m, g, v, y, w]);
        return null == k
          ? null
          : (0, e.createElement)(
      ...
      function y(t) {
        ...
        return (function (t, n) {
          ...
          let d = i.pathname || "/",
            p = (function (e, t, n) {
              void 0 === n && (n = "/");
              let r = L(("string" == typeof t ? c(t) : t).pathname || "/", n);
              if (null == r) return null;
              let a = S(e);
              !(function (e) {
                e.sort((e, t) =>
              ...
              return l;
            })(t, { pathname: "/" === o ? d : d.slice(o.length) || "/" });
          return (function (t, n) {
            return (
              void 0 === n && (n = []),
              null == t
            ...
            p &&
              p.map((e) =>
                Object.assign({}, e, {
                  ...
                  pathname: T([o, e.pathname]),
                  pathnameBase:
                    "/" === e.pathnameBase ? o : T([o, e.pathnameBase]),
                })
              ),
            r
          );
      ...
      function w() {
        return b() || f(!1), (0, e.useContext)(p).location;
      }
      function k() {
        b() || f(!1);
        let { basename: t, navigator: n } = (0, e.useContext)(d),
              ...
              let o = (function (e, t) {
                ...
                let {
                  ...
                  l = n
                    ...
                    : t;
                return { pathname: l, search: M(r), hash: R(a) };
              })(a, r);
              return (
                l &&
                  "/" !== l &&
      ...
      const E = (0, e.createContext)(null);
      function x(t) {
        let n = [];
        return (
          e.Children.forEach(t, (t) => {
            ...
            if (t.type === e.Fragment)
              return void n.push.apply(n, x(t.props.children));
            t.type !== g && f(!1);
            let r = {
            ...
            t.props.children && (r.children = x(t.props.children)), n.push(r);
          }),
          n
        );
      }
      ...
      function N(e, t) {
        ...
        for (let e = 0; e < n.length; ++e) {
          ...
          l.push({
            ...
            pathnameBase: T([a, s.pathnameBase]),
            route: c,
          }),
      ...
      function I({ actualWord: t, msg: n, won: r }) {
        let l = k(),
          o = 0;
        return (
          r && (o = -1),
              ...
              e.createElement(
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    {
                      className:
                        "result-pane__header " + (r ? "success" : "danger"),
                    },
                    n
                  ),
                  e.createElement(
      ...
      function F({ maskedWord: t }) {
        let n = 0;
        return e.createElement(
          "div",
          { className: "display-flex justify-content-around word-flex" },
          t.map((t) =>
            e.createElement(
              "span",
              { key: n++, className: "word" },
              " ",
              t,
              " "
            )
      ...
      function j({ playedLetters: t, onSelect: n }) {
        const r = new Set([...t]);
        let a = 0;
        return e.createElement(
          "div",
        ...
        return e.createElement(
          ...
          e.createElement(
            ...
            e.createElement(
              "div",
              { className: "left-pane" },
              e.createElement(a, { livesLeft: t.livesLeft })
            ),
            e.createElement(
              "div",
              { className: "right-pane" },
              e.createElement(F, { maskedWord: t.maskedWord }),
              e.createElement(j, {
                playedLetters: t.playedLetters,
                onSelect: n,
              })
            )
          )
      ...
      function A({ session: t, guess: n, start: a, categories: l }) {
        const o = !!t,
          i = o && t.result && t.livesLeft > 0;
        let u = "";
        return (
          o && 0 === t.livesLeft && (u = "Actual Word was: " + t.actualWord),
          e.createElement(
            e.Fragment,
            null,
            e.createElement(
              ...
              e.createElement(g, {
                path: "/",
                element: e.createElement(r, { onStart: a, categories: l }),
              }),
              e.createElement(g, {
                path: "/api/session/:id/play",
                element: e.createElement(U, { session: t, guess: n }),
              }),
              e.createElement(g, {
                path: "/api/session/:id/result",
                element: e.createElement(I, {
                  actualWord: u,
                  msg: i ? "You Won!" : "Game Over!",
                  won: i,
                }),
              })
            )
      ...
      function W() {
        const [t, n] = (0, e.useState)(null),
          [r, a] = (0, e.useState)([{ id: -1, category: "" }]);
        let l = k();
        return (
          (0, e.useEffect)(async () => {
            const e = await (0, $.getCategories)();
            a(e);
          }, []),
          e.createElement(
            e.Fragment,
            null,
            e.createElement("h1", { className: "hangman-header" }, " Hangman"),
            e.createElement(A, {
              session: t,
              guess: async (e) => {
                const r = await (0, $.playInSession)(t.id, e);
                n(r), r.result && l(`/api/session/${r.id}/result`);
              },
              start: async (e, t) => {
                for (let a = 0; a < r.length; a++)
                  if (r[a].category === t) {
                    const t = await (0, $.createSession)(e, r[a].id);
                    n(t), l(`/api/session/${t.id}/play`);
                    break;
                  }
              },
              categories: r,
      ...
      function re(t) {
        ...
        null == i.current &&
          (i.current = (function (e) {
            ...
            return (
              null == m &&
                ((m = 0), d.replaceState(l({}, d.state, { idx: m }), "")),
              {
                get action() {
                  return h;
                },
                ...
                push: function e(t, l) {
                  ...
                  if (
                    ...
                    var s = [{ usr: u.state, key: u.key, idx: m + 1 }, n(u)];
                    (u = s[0]), (s = s[1]);
                    try {
                      d.pushState(u, "", s);
                    } catch (e) {
                ...
                block: function (e) {
                  var t = y.push(e);
                  return (
                    1 === y.length && f.addEventListener("beforeunload", u),
                    function () {
                      t(), y.length || f.removeEventListener("beforeunload", u);
                    }
                  );
                },
              }
      ...
      (ne.styleTagTransform = ee()),
        (ne.setAttributes = X()),
        (ne.insert = K().bind(null, "head")),
        (ne.domAPI = Q()),
        (ne.insertStyleElement = Z()),
        V()(te.Z, ne),
        te.Z && te.Z.locals && te.Z.locals;
      const ae = () => e.createElement(re, null, e.createElement(W, null));
      t.render(e.createElement(ae, null), document.getElementById("app"));
    })();
})();
